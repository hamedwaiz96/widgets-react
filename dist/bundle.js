...
function (_React$Component) {
  ...
  function Clock(props) {
    ...
    var date = new Date();
    _this.state = {
      hours: date.getHours() / 10 >= 1 ? date.getHours() : "0".concat(date.getHours()),
      seconds: date.getSeconds() / 10 >= 1 ? date.getSeconds() : "0".concat(date.getSeconds()),
      minutes: date.getMinutes() / 10 >= 1 ? date.getMinutes() : "0".concat(date.getMinutes())
    };
    return _this;
  }
  ...
  _createClass(Clock, [{
    ...
    value: function render() {
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h1", null, this.state.hours, ":", this.state.minutes, ":", this.state.seconds), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("input", {
...
var PROPS = [{
  title: 'msn',
  content: 'hello my name is msn and i like msn!'
}, {
  title: 'google',
  content: 'hello my name is google and i like google!'
}, {
  title: 'yahoo',
...
function (_React$Component) {
  ...
  function Tabs(props) {
    ...
    _this.groups = _this.props.group;
    _this.state = {
      clicked: []
    };
    return _this;
  ...
  _createClass(Tabs, [{
    key: "clickedToggle",
    value: function clickedToggle(title) {
      var self = this;
      var new_clicked = this.state.clicked.slice();
    ...
    value: function render() {
      var self = this;
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("ul", null, this.groups.map(function (value, index) {
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("li", {
          key: index,
          onClick: self.clickedToggle.bind(self, value.title)
        }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h1", null, value.title), self.state.clicked.includes(value.title) ? react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("p", null, value.content) : "");
      }));
    }
  }]);
...
/* harmony import */ var _frontend_root_jsx__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./frontend/root.jsx */ "./frontend/root.jsx");



window.addEventListener("DOMContentLoaded", function () {
  var root = document.getElementById("root");
  react_dom__WEBPACK_IMPORTED_MODULE_1___default.a.render(react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_frontend_root_jsx__WEBPACK_IMPORTED_MODULE_2__["default"], null), root);
});
